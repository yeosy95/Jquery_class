...
//     $('#h_bottom').stop().animate({'height':'320px'},500, 'easeInExpo'); //높이가 커짐
//     $('.sub').fadeIn(2000);
//   });
...
// // 메모리 공간에있는 cue라는 jquery에서 사용하는 메모리 기억공간을 없애 주는걸 stop()이라함
//     $('.sub').fadeOut(700);
//   });
